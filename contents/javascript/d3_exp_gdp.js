...
var svg_gdp = d3.select('#vis_gdp')
  ...
  svg_gdp.append("linearGradient")
    ...
    svg_gdp.append("text")
        ...
        .text("UK expenditure by function 2001-2016 % GDP");
...
button.addEventListener('change', function() {
  ...
  d3.json("/datasets/data_spending_gdp.json", function(data) {
    console.log(data);
    ...
    function mouseOver(d) {
      ...
      tooltip
        .style('display', null)
        .html('<p>UK spending in ' + gov_function_title + ' was ' + value_function + '% of GDP in ' + displayDate + '<br>Correlation coefficient value with nominal pounds: ' + correlation + '</p>');
    }
